...
//    @Cacheable(cacheNames = "flowers",unless = "#result==null")
...
//    @Cacheable(cacheNames = "findfclass",unless = "#result==null")
    ...
    @CachePut(value = "flower",key = "#flower.flowerid")
    public void saveUpdate(Flower flower){
        flowerMapper.updateById(flower);
    }

    public Map<String,Object> queryPage(String fname,String fclass,Integer minprice,Integer maxprice,
